    ...
    return (
        <>
            <div className="w3-content w3-display-container" style={{ maxWidth: "1200" }}>
                <img className="mySlides" src="Banner-black-friday-sexshop.webp" style={{ width: "100%", display: slideIndex==1 ?'block' :'none' }} />
                <img className="mySlides" src="blackpromo2.jpg" style={{ width: "100%", display: slideIndex==2 ?'block' :'none' }} />
